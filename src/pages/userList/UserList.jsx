...
export default function UserList() {
    ...
    const columns = [
        ...
        { field: 'transaction', headerName: 'Transaction Amount', type: 'number', width: 200, },
    ...
    return (
        <div className='userList'>
            <DataGrid rows={data} disableSelectionOnClick columns={columns} pageSize={9} rowsPerPageOptions={[5]} checkboxSelection />
        </div>
    )
}
